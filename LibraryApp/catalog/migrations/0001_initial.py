    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.TextField(help_text='entera a description', max_length=10000)),
                ('isbn', models.CharField(help_text='International code', max_length=13, unique=True, verbose_name='ISBN')),
        ...
        migrations.CreateModel(
            name='BookInstance',
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, help_text='Unique ID for particula book(local id)', primary_key=True, serialize=False)),
